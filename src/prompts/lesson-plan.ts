...
function getLessonPlanRules(language: LanguageMode): string {
  ...
  return [
    ...
    'Question 1 should require the learner to translate a Simplified Chinese prompt into the target language.',
    'Question 1 should be derived from the material\'s meaning and topic, but the question prompt itself must be written in Simplified Chinese and answered in the target language.',
