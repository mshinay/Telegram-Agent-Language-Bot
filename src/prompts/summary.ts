...
function getSummaryRules(language: LanguageMode): string {
  ...
  return [
    ...
    'When relevant, strengths may mention translation accuracy into the target language, paraphrasing ability, self-expression ability, grammar stability, clarity, or naturalness.',
    ...
    'When relevant, mistakes may mention translation meaning errors, omissions, weak paraphrasing, over-copying source wording, weak self-expression, grammar problems, awkward wording, or unnatural phrasing.',
    ...
    'When useful, review points may separately address translation-into-target-language accuracy, paraphrasing skill, and free-expression skill.',
